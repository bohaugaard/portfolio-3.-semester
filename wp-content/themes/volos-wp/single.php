                        ...
                        <div class="single-content-wrapper content-1170 center-relative">     
                            ...
                            <div class="single-content-wrapper content-960 center-relative">
                                ...
                                <div class="entry-content"> 
                                    ...
                                    <?php
                                    $defaults = array(
                                        'before' => '<p class="wp-link-pages top-50">' . esc_html__('Pages:', 'volos-wp'),
                                        'after' => '</p>',
                ...
                <div class="nav-links content-750 center-relative">                
                    ...
                    if (is_a($prev_post, 'WP_Post')):
                        ...
                        <div class="nav-previous">                        
                            <p><?php echo esc_html__('PREVIOUS STORY', 'volos-wp'); ?></p>                        
                    ...
                    if (is_a($next_post, 'WP_Post')):
                        ?>                
                        <div class="nav-next">
                            <p><?php echo esc_html__('NEXT STORY', 'volos-wp'); ?></p>                        
