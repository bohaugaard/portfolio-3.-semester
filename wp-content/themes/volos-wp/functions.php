...
if (!function_exists('cocobasic_theme_setup')) {
    ...
    function cocobasic_theme_setup() {
        ...
        load_theme_textdomain('volos-wp', $lang_dir);
        ...
        if ((get_option('cocobasic_body_background') !== '' && get_option('cocobasic_body_background') !== false)):
            add_filter('body_class', 'cocbasic_body_class');
        endif;
...
if (!function_exists('cocobasic_google_fonts_url')) {
    ...
    function cocobasic_google_fonts_url() {
        ...
        if ('off' !== _x('on', 'Google font: on or off', 'volos-wp')) {
            $font_url = add_query_arg('family', urlencode('Poppins:400,700,800'), "//fonts.googleapis.com/css");
        }
        return $font_url;
    }
...
if (!function_exists('cocobasic_load_scripts_and_style')) {
    ...
    function cocobasic_load_scripts_and_style() {
        ...
        wp_enqueue_style('volos-google-fonts', cocobasic_google_fonts_url(), array(), '1.0.0');
...
//register and load styles which is used on every pages       
        wp_enqueue_style('volos-clear-style', $base_theme_url . '/css/clear.css');
        wp_enqueue_style('volos-common-style', $base_theme_url . '/css/common.css');
        wp_enqueue_style('sm-cleen', $base_theme_url . '/css/sm-clean.css');
        wp_enqueue_style('volos-main-theme-style', $base_theme_url . '/style.css');
...
//JavaScript
        ...
        wp_enqueue_script('volos-main', $base_theme_url . '/js/main.js', array('jquery'), false, true);
        ...
        wp_localize_script('volos-main', 'ajax_var', array(
        ...
        wp_add_inline_style('volos-main', $inlineHeaderCss->cocobasic_theme_customized_style());
    }
...
if (!function_exists('cocobasic_search_form')) {
	...
	<label>		
	<input autocomplete="off" type="search" class="search-field" placeholder="' . esc_attr__('Search', 'volos-wp') . '" value="" name="s" title="' . esc_attr__('Search for:', 'volos-wp') . '" /> 
</label>    
</form>';
...
if (!function_exists('cocobasic_wp_register_required_plugins')) {
    ...
    function cocobasic_wp_register_required_plugins() {
        ...
        $plugins = array(
            array(
                'name' => esc_html('CocoBasic - Volos WP'),
            ...
            array(
                'name' => esc_html('CocoBasic - Volos Elementor Widgets'),
...
if (!function_exists('cocobasic_wp_widgets_init')) {
    ...
    function cocobasic_wp_widgets_init() {
        register_sidebar(array(
            'name' => esc_html__('Footer Sidebar', 'volos-wp'),
            'id' => 'footer-sidebar',
            'description' => esc_html__('Widgets in this area will be shown in footer on all pages and posts', 'volos-wp'),
...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="Background Image for all pages">
if (!function_exists('cocbasic_body_class')) {

    function cocbasic_body_class($classes) {
        $classes[] = 'cocobasic-has-background';
        return $classes;
    }
...
//</editor-fold>
// <editor-fold defaultstate="collapsed" desc="Get Custom Elemenetor Footer Content">
