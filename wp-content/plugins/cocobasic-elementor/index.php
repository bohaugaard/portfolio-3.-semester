...
/**
 * Plugin Name: CocoBasic - Volos Elementor Widgets 
 * Description: Custom Elementor Widgets used in Volos WordPress Theme.
 * Version: 1.0
 * Author: CocoBasic
...
if (!class_exists('CocoBasicLandingAddons')) :
    ...
    final class CocoBasicLandingAddons {
        ...
        public function cocobasic_frontend_enqueue_script() {
            ...
            wp_enqueue_script('circle-progress', PM_PLUGIN_URL . 'assets/js/circle-progress.min.js', '', '', true);
            wp_enqueue_script('istope.pkgd', PM_PLUGIN_URL . 'assets/js/isotope.pkgd.js', '', '', true);
        ...
        public function include_widgets($widgets_manager) {
            ...
            require_once PM_ADDONS_DIR . 'skills-circle/index.php';
            require_once PM_ADDONS_DIR . 'skills-lines/index.php';
            require_once PM_ADDONS_DIR . 'music-waves/index.php';
        }
